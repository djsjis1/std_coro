...
namespace coro
{
    ...
    namespace net
    {
        ...
        public:
            ...
            {
                CreateIoCompletionPort(reinterpret_cast<HANDLE>(s), iocp_, 0, 0);
            }
            ...
            {
                CreateIoCompletionPort(h, iocp_, 0, 0);
            }
            ...
            int wait_for(std::chrono::milliseconds timeout) override
            {
                ...
                DWORD ms = (timeout.count() > (long long)(INFINITE - 1))
                               ? INFINITE - 1
            ...
            void wake() override
            {
                PostQueuedCompletionStatus(iocp_, 0, WAKE_KEY, nullptr);
            }
